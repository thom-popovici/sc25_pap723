...
void function(int cold_runs, int hot_runs)
{
	...
	for(int r = 0; r < cold_runs + hot_runs; ++r)
	{
		...
		fft_compute(CUFFT_FORWARD, fft_plan0, 128, 16384, 1, 2097152, A0, 2097152, temp0);
		// add measuring things
		...
		fft_compute(CUFFT_FORWARD, fft_plan1, 1, 16384, 128, 2097152, temp0, 2097152, B0);
		// add measuring things
