...
void function(int cold_runs, int hot_runs)
{
	...
	for(int r = 0; r < cold_runs + hot_runs; ++r)
	{
		...
		fft_compute(CUFFT_FORWARD, fft_plan0, 512, 16384, 1, 8388608, A0, 8388608, temp0);
		// add measuring things
		...
		fft_compute(CUFFT_FORWARD, fft_plan1, 1, 16384, 512, 8388608, temp0, 8388608, B0);
		// add measuring things
