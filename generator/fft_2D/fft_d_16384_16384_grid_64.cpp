...
void function(int cold_runs, int hot_runs)
{
	...
	for(int r = 0; r < cold_runs + hot_runs; ++r)
	{
		...
		fft_compute(CUFFT_FORWARD, fft_plan0, 256, 16384, 1, 4194304, A0, 4194304, temp0);
		// add measuring things
		...
		fft_compute(CUFFT_FORWARD, fft_plan1, 1, 16384, 256, 4194304, temp0, 4194304, B0);
		// add measuring things
