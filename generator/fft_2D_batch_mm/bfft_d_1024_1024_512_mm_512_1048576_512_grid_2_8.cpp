...
void function(int cold_runs, int hot_runs)
{
	...
	for(int r = 0; r < cold_runs + hot_runs; ++r)
	{
		...
		fft_compute(CUFFT_FORWARD, fft_plan0, 1, 1024, 32768, 33554432, B0, 33554432, temp0);
		// add measuring things
		cudaEventRecord(counters[1]);
		pack_data(512, 2, 32768, 33554432, (double*) temp0, 33554432, (double*) temp1);
		// add measuring things
		...
		unpack_data(262144, 64, 2, 33554432, (double*) temp0, 33554432, (double*) temp1);
		// add measuring things
		cudaEventRecord(counters[4]);
		fft_compute(CUFFT_FORWARD, fft_plan1, 512, 1024, 64, 33554432, temp1, 33554432, temp0);
		// add measuring things
		...
		unpack_data(512, 32768, 2, 33554432, (double*) temp0, 33554432, (double*) Tx0);
		// add measuring things
